...
|-----------------------------|-----------------------------|-----------------------------|----------------------------|----------------------------|-------------------------------|
| [![Redux](https://skillicons.dev/icons?i=redux)](https://redux.js.org/) | [![React Query](https://skillicons.dev/icons?i=reactquery)](https://tanstack.com/query/latest) | [![Context API](https://skillicons.dev/icons?i=react)](https://reactjs.org/docs/context.html) | [![Styled Components](https://skillicons.dev/icons?i=styledcomponents)](https://styled-components.com/docs) | [![React Hook Form](https://skillicons.dev/icons?i=reacthookform)](https://react-hook-form.com/) | [![React Router](https://skillicons.dev/icons?i=reactrouter)](https://reactrouter.com/en/main) |
